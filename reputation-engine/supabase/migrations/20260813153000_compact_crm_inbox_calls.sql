...
as $$
  select jsonb_strip_nulls(jsonb_build_object(
    ...
    'inboundId', lead.data -> 'inboundId', 'mergedIntoLeadId', lead.data -> 'mergedIntoLeadId',
    ...
    'assignedRep', lead.data -> 'assignedRep', 'assignedRepName', lead.data -> 'assignedRepName',
    'assignedRepUserId', lead.data -> 'assignedRepUserId',
    'callLogs', coalesce((
      select jsonb_agg(call - array['transcript', 'aiSummary']::text[])

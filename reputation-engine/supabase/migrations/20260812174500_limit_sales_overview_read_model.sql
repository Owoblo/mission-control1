-- Keep the operational dashboard bounded. Full history remains available via
-- CRM search and individual lead-detail endpoints.
...
as $$
  ...
  from (
    select data from public.crm_leads
    where deleted = false

...
exports.INVENTORY_PRESETS = void 0;
exports.createInventoryItemFromPreset = createInventoryItemFromPreset;
exports.matchInventoryPreset = matchInventoryPreset;
// Helper to build a preset entry cleanly
function p(id, label, icon, room, cubicFeet, weightLbs, notes) {
    return {
        id,
        label,
        icon,
...
function createInventoryItemFromPreset(preset) {
    return {

...
exports.createLeadDraftState = createLeadDraftState;
exports.buildSavedLeadSignature = buildSavedLeadSignature;
exports.buildDraftLeadSignature = buildDraftLeadSignature;
exports.buildLeadDraftPayload = buildLeadDraftPayload;
const helpers_1 = require("./helpers");
const sales_1 = require("../../../../lib/sales");
function getDraftLeadName(lead) {
    if (lead.leadKind === 'realtor_opportunity' && lead.primaryContactRole !== 'customer') {
        return lead.realtorName || '';
    }
    return lead.name || '';
}
function getDraftLeadPhone(lead) {
    if (lead.leadKind === 'realtor_opportunity' && lead.primaryContactRole !== 'customer') {
        return lead.realtorPhone || '';
    }
    return lead.phone || '';
}
function getDraftLeadEmail(lead) {
    if (lead.leadKind === 'realtor_opportunity' && lead.primaryContactRole !== 'customer') {
        return lead.realtorEmail || '';
    }
    return lead.email || '';
}
function createLeadDraftState(lead) {
    return {
        ...
        assignedRep: (0, sales_1.getLeadAssignedRepName)(lead) || '',
...
function buildSavedLeadSignature(lead) {
    return (0, helpers_1.buildLeadSignature)({
...
function buildDraftLeadSignature(draft) {
    return (0, helpers_1.buildLeadSignature)({
        name: draft.leadName,
...
function buildLeadDraftPayload(lead, draft) {
    const preserveOpportunityIdentity = lead.leadKind === 'realtor_opportunity' &&

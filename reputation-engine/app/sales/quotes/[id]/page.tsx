...
import { enqueueQuoteSendJobs, fetchSalesQuote, saveSalesFollowUp, updateSalesLead, updateSalesQuote } from '@/lib/sales-api'
...
Saturn Star Movers`
  ...
  async function sendBothNow() {
    ...
    try {
      ...
      setSendBothResult(Object.fromEntries(queued.jobs.map(job => [job.channel, true])) as { email?: boolean; sms?: boolean })

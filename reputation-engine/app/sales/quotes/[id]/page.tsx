...
Saturn Star Movers`
  ...
  const smsDraft = useMemo(() => {
    ...
    if (invoiceStyleTerms) {
      return isRevision
        ? `Hi ${firstName}, we updated your Saturn Star commercial estimate ${quote.number}. Starting at ${formatMoney(subtotal)} + HST. Payment terms: ${paymentTermsLabel(paymentTerms)}. Review here: ${acceptUrl}`
        : `Hi ${firstName}, your Saturn Star commercial estimate ${quote.number} is ready. Starting at ${formatMoney(subtotal)} + HST. Review and approve here: ${acceptUrl}`
    }
    return isRevision

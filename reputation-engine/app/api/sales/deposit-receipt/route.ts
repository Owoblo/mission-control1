 ...
 * Called after any deposit is confirmed — card, cash, cheque, or e-transfer.
 */
...
export async function POST(request: Request) {
  ...
  try {
    const {
      toEmail, toName,
      quoteNumber, moveDate,
      originCity, destCity,
      depositAmount, balanceAmount, totalAmount,
      paymentMethod,           // 'Credit Card', 'Cash', 'Cheque', 'Interac E-Transfer'
      cardLast4,               // optional — only for card payments
...
<table width="100%" style="max-width:520px;" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td style="background:#ffffff;padding:32px 36px;">
      ...
      <p style="margin:0 0 20px;font-size:15px;color:#1a2744;">Hi ${toName.split(' ')[0]},</p>

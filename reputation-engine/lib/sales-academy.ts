    ...
    lessons: [
      ...
      },
      {
        ...
        flashcards: [
          ...
          { id: 'star-assess-5', tag: 'Uncertain', front: 'What do I do when only the timing window is known?', back: 'Record the useful window, price the known scope, state which pieces may adjust, and create a dated milestone to confirm the exact day.' },
          { id: 'star-assess-6', tag: 'Destination', front: 'What if the customer knows the city but has not chosen a home?', back: 'Model travel to the city, ask the expected property type, keep exact mileage and access provisional, and nudge for the address later.' },
          { id: 'star-assess-7', tag: 'Consulting', front: 'What are the three estimate modes?', back: 'Firm estimate, locked-scope estimate, and planning estimate. Uncertainty changes the mode; it does not end the consultation.' },
        ],
      },
      {
      ...
      {
        id: 'home-not-sold-scenario',
        sectionId: 'assess',
        type: 'scenario',
        title: 'Scenario: the house has not sold',
        summary: 'The customer needs a transition plan before the calendar is settled.',
        scenario: {
          customerLine: 'We have not sold yet and we do not know where we are moving, but we want to understand the cost.',
          setup: 'The origin, household, and desired service level can still be understood and priced.',
          prompt: 'What is the strongest consulting response?',
          options: [
            {
              id: 'wait-for-sale',
              label: 'Ask them to return after the house sells and the destination is known.',
              outcome: 'You abandoned the customer at the stage where expert guidance was most valuable.',
              coachingNote: 'Early uncertainty is a consultation opportunity, not a dead lead.',
            },
            {
              id: 'lock-known-scope',
              label: 'Verify the origin inventory, map packing/storage/cleaning needs, price the known scope, state the variable allowances, and agree on a sale-status check-in.',
              outcome: 'Correct. The customer leaves with a usable plan and Saturn Star remains beside them as the facts develop.',
              coachingNote: 'Be precise about what is locked: the known inventory and selected services, not an unknown route or unlimited storage duration.',
              isBest: true,
            },
            {
              id: 'invent-destination',
              label: 'Use an average destination address and present the result as a final locked price.',
              outcome: 'That hides material uncertainty and creates a future pricing dispute.',
              coachingNote: 'Allowances must be visible and revisable.',
            },
          ],
        },
      },
      {
        id: 'destination-city-only-scenario',
        sectionId: 'assess',
        type: 'scenario',
        title: 'Scenario: the destination city is known',
        summary: 'A missing street address should not erase the route context already available.',
        scenario: {
          customerLine: 'We know it will be Ottawa, but we have not picked the house yet.',
          setup: 'The rep can model the market-level route while isolating the unknown destination access.',
          prompt: 'What should the rep do next?',
          options: [
            {
              id: 'ask-address-repeatedly',
              label: 'Keep asking for the exact address until the customer provides one.',
              outcome: 'The customer cannot provide a fact they do not have, and the conversation becomes frustrating.',
              coachingNote: 'Ask the next answerable question.',
            },
            {
              id: 'property-lane',
              label: 'Ask whether they expect a house, apartment, condo, or storage destination; model travel to Ottawa and mark final mileage/access for later confirmation.',
              outcome: 'Correct. You advanced the plan without pretending the destination is complete.',
              coachingNote: 'The CRM should nudge for the property and address when it becomes available.',
              isBest: true,
            },
            {
              id: 'omit-destination',
              label: 'Ignore the destination entirely and price only the loading.',
              outcome: 'That withholds useful context and understates the commercial scope.',
              coachingNote: 'Known city-level route information still belongs in the estimate.',
            },
          ],
        },
      },

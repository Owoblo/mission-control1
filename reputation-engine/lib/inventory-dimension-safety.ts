...
export interface SafeInventoryDimensions {
  cubicFeet: number
  weightLbs: number
  adjusted: boolean
  reason?: string
 ...
 */
export function normalizeDetectedInventoryDimensions(input: {
  name: string
  qty?: number
  cubicFeet?: number
  weightLbs?: number
}): SafeInventoryDimensions {
